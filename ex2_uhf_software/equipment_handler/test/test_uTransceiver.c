...
//  UHF_genericRead(246, &read_callsign);
//
...
//  UHF_genericRead(248, &read_beacon);
//
...
//  UHF_genericRead(251, &read_content);
...
//  UHF_genericWrite(253, &new_write);
//
//  uhf_framStruct read;
