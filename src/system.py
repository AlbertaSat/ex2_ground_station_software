    ...
    "SCHEDULER": {
        ...
        "subservice": {
            ...
            "GET_SCHEDULE": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "count": ">b", "cmds": "var"},
                },
            },
        },
    },
    "SET_PIPE": {
        ...
        "subservice": {
            "UHF_GS_PIPE": {
                ...
                "subPort": 0,
                "inoutInfo": {"args": None, "returns": {"err": ">b"}},  # test  # err
            }
        },
    },
    "TIME_MANAGEMENT": {
    ...
    "EPS_FIRMWARE": {
        ...
        "subservice": {
            ...
            "GET_CURRENT_STATE": {
                ...
                "subPort": 5,
                "inoutInfo": {"args": None, "returns": {"err": "<b", "state": "<b"}},
            },
    ...
    "GENERAL": {
        ...
        "subservice": {
            "REBOOT": {
                ...
                "subPort": 0,
                "inoutInfo": {"args": {"Mode": ">B"}, "returns": {"err": ">b"}},  # err
            },
            "DEPLOY_DEPLOYABLES": {
            ...
            "GET_UHF_WATCHDOG_TIMEOUT": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "timeout_ms": ">u4"},  # err status
                },
            },
            ...
            "BEACON_TASK_GET_STATE": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "state": ">?"},  # err status
                },
            },
            "GET_SOLAR_SWITCH_STATUS": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "state": ">b"},  # err status
                },
            },
            "SET_SOLAR_SWITCH": {
    ...
    "COMMUNICATION": {
        ...
        "subservice": {
            ...
            "UHF_RESTORE": {
                ...
                "subPort": 26,
                "inoutInfo": {
                    "args": {"Set_1_to_confirm": ">u1"},  # Safety precaution
                    "returns": {
                        "err": ">b",
                    },
                },
    ...
    "CONFIGURATION": {
        ...
        "subservice": {
            ...
            "SET_CONFIG": {
                ...
                "subPort": 4,
                "inoutInfo": {
                    "args": {"id": "<u2", "type_id": "<u1", "Config": "var"},
                    "returns": {
                        "err": ">B",
                    },
                },
    ...
    "HOUSEKEEPING": {
        ...
        "subservice": {
            "GET_HK": {
                ...
                "subPort": 0,
                "inoutInfo": {
                    "args": {"Limit": ">u2", "Before_id": ">u2", "Before_time": ">u4"},
            ...
            "SET_MAX_FILES": {
                ...
                "subPort": 1,
                "inoutInfo": {"args": {"Max": "<u2"}, "returns": {"err": ">b"}},
            },
            "GET_MAX_FILES": {
                "what": "Get max number of hk entries to store",
                "subPort": 2,
                "inoutInfo": {"args": None, "returns": {"err": ">b", "max": ">u2"}},
            },
            "GET_INSTANT_HK": {
                "what": "Fetch system-wide housekeeping right now",
                "subPort": 3,
                "inoutInfo": {"args": None, "returns": obc_housekeeping},
            },
            "GET_LATEST_HK": {
    ...
    "GROUND_STATION_WDT": {
        ...
        "subservice": {
            "RESET_WDT": {
                ...
                "subPort": 0,
                "inoutInfo": {"args": {"Key": "<u2"}, "returns": {"err": ">B"}},
            },
            "GET_WDT_REMAINING": {
        ...
        "subservice": {
            ...
            "SINGLE_OUTPUT_CONTROL": {
                ...
                "inoutInfo": {
                    ...
                    "args": {"Channel": "<B", "State": "<B", "Delay": "<u2"},
                    "returns": {"err": ">b"},
                },
            },
            "ALL_OUTPUT_CONTROL": {
                ...
                "subPort": 1,
                "inoutInfo": {"args": {"StateMask": "<u4"}, "returns": {"err": ">b"}},
            },
    ...
    "UPDATER": {
        ...
        "subservice": {
            "INITIALIZE_UPDATE": {
                ...
                "subPort": 0,
                "inoutInfo": {
                    "args": {"Address": ">u4", "Size": ">u4", "CRC": ">u2"},
                    "returns": {"err": ">b"},
                },
            },
            "PROGRAM_BLOCK": {
                ...
                "subPort": 1,
                "inoutInfo": {
                    "args": {"Arg1": ">u4", "Arg2": ">u4"},  # TODO: Better names
                    "returns": {"err": ">b"},
                },
            },
            "GET_PROGRESS": {
    ...
    "LOGGER": {
        ...
        "subservice": {
            ...
            "SET_FILE_SIZE": {
                ...
                "subPort": 3,
                "inoutInfo": {"args": {"Size": ">u4"}, "returns": {"err": ">b"}},
            },
            "GET_FILE_SIZE": {
                "what": "Get the size of the logger files.",
                "subPort": 2,
                "inoutInfo": {"args": None, "returns": {"err": ">b", "size": ">u4"}},
            },
        },
    },
    "CLI": {
        ...
        "subservice": {
            "SEND_CMD": {
                ...
                "subPort": 0,
                "inoutInfo": {
                    "args": {"Len": "B", "Command": "a128"},
                    "returns": {"status": ">b", "resp": "a128"},
                },
            }
        },
    },
    "ADCS": {  # refer to the adcs service
        ...
        "subservice": {
            ...
            "ADCS_INITIATE_FILE_UPLOAD": {
                ...
                "subPort": 8,
                "inoutInfo": {
                    "args": {"File_dest": ">u1", "Block_size": ">u1"},
                    "returns": {"err": ">b"},
                },
            },
            "ADCS_FILE_UPLOAD_PACKET": {
                ...
                "subPort": 9,
                "inoutInfo": {
                    "args": {"Packet_num": ">u2", "File_bytes": ">u1"},
                    "returns": {"err": ">b", "file_bytes": ">b"},
                },
            },
            ...
            "ADCS_INITIATE_DOWNLOAD_BURST": {
                ...
                "subPort": 13,
                "inoutInfo": {
                    "args": {"Msg_len": ">u1", "Ignore_hole_map": ">?"},
                    "returns": {
                        "err": ">b",
                    },
                },
            ...
            "ADCS_GET_SRAM_LATCHUP_COUNT": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "Sram1": ">u2", "Sram2": ">u2"},
                },
            },
            ...
            "ADCS_SET_HOLE_MAP": {
                ...
                "subPort": 32,
                "inoutInfo": {
                    "args": {"Hole_Map": ">u1", "Hole_Map_Num": ">u1"},
                    "returns": {"err": ">b", "Hole_Map": ">u1"},
                },
            },
            "ADCS_SET_UNIX_T": {
                ...
                "subPort": 33,
                "inoutInfo": {
                    "args": {"Unix_T": ">u4", "Count_Millis": ">u2"},
                    "returns": {
                        "err": ">b",
                    },
                },
            ...
            "ADCS_GET_CACHE_EN_STATE": {
                ...
                "subPort": 34,
                "inoutInfo": {"args": None, "returns": {"err": ">b", "En_State": ">?"}},
            },
            "ADCS_GET_SRAM_SCRUB_SIZE": {
                "what": "Returns SRAM scrubbing size.",
                "subPort": 35,
                "inoutInfo": {"args": None, "returns": {"err": ">b", "Size": ">u2"}},
            },
            "ADCS_GET_UNIXTIME_SAVE_CONFIG": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "When": ">u1", "Period": ">u1"},
                },
            },
            "ADCS_GET_HOLE_MAP": {
            ...
            "ADCS_GET_UNIX_T": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "Unix_t": ">u4", "Count_Ms": ">u2"},
                },
            },
            ...
            "ADCS_COPY_PROGRAM_INTERNAL_FLASH": {
                ...
                "subPort": 43,
                "inoutInfo": {
                    "args": {"Index": ">u1", "Overwrite_flag": ">u1"},
                    "returns": {
                        "err": ">b",
                    },
                },
            ...
            "ADCS_SET_ATTITUDE_CONTROL_MODE": {
                ...
                "subPort": 50,
                "inoutInfo": {
                    "args": {"Control_mode": ">u1", "Timeout": ">u2"},
                    "returns": {
                        "err": ">b",
                    },
                },
            ...
            "ADCS_SAVE_IMG": {
                ...
                "subPort": 58,
                "inoutInfo": {
                    "args": {"Cam_Select": ">u1", "Img_Size": ">u1"},
                    "returns": {
                        "err": ">b",
                    },
                },
            ...
            "ADCS_SET_MAGNETORQUER_OUTPUT": {
                ...
                "subPort": 59,
                "inoutInfo": {
                    "args": {"Mtq_X": ">i2", "Mtq_Y": ">i2", "Mtq_Z": ">i2"},
                    "returns": {
                        "err": ">b",
                    },
                },
            ...
            "ADCS_SET_WHEEL_SPEED": {
                ...
                "subPort": 60,
                "inoutInfo": {
                    "args": {"Wheel_X": ">i2", "Wheel_Y": ">i2", "Wheel_Z": ">i2"},
                    "returns": {
                        "err": ">b",
                    },
                },
            ...
            "ADCS_GET_ACP_LOOP_STAT": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "Time": ">u2", "Execution_point": ">u1"},
                },
            },
            "ADCS_GET_IMG_SAVE_PROGRESS": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "Percentage": ">u1", "Status": ">u1"},
                },
            },
            ...
            "ADCS_SET_USERCODED_SETTING": {
                ...
                "subPort": 106,
                "inoutInfo": {
                    "args": {"User_Ctrlr_Set": ">O20", "User_Estim_Set": ">020"},
                    "returns": {
                        "err": ">b",
                    },
                },
    ...
    "DFGM": {
        ...
        "subservice": {
            "DFGM_RUN": {
                ...
                "subPort": 0,
                "inoutInfo": {"args": {"Seconds": ">u4"}, "returns": {"err": ">b"}},
            },
            "DFGM_START": {
    ...
    "NS_PAYLOAD": {
        ...
        "subservice": {
            ...
            "CAPTURE_IMAGE": {
                ...
                "inoutInfo": {
                    "args": None,
                    "returns": {"err": ">b", "confirmation_err": ">B"},
                },
            },
            "CONFIRM_DOWNLINK": {
            ...
            "GET_SW_VERSION": {
                ...
                "subPort": 7,
                "inoutInfo": {"args": None, "returns": {"err": ">b", "version": ">S7"}},
            },
            "DOWNLOAD_IMAGE": {
            ...
            "NV_START": {
                ...
                "subPort": 11,
                "inoutInfo": {
                    "args": {"Repeats": ">u2", "Blocksize": ">u2", "Filename": ">S128"},
                    "returns": {
                        "err": ">b",
                    },
                },
