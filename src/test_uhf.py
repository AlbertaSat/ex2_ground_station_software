...
def testAllCommandsToOBC():
    ...
    sendAndExpect('obc.communication.UHF_SET_SCW(0 1 0 3 0 0 0 0 0 1 0 0)', {'err':0}) #sometimes it won't reach its subservice!
    ...
    sendAndExpect('obc.communication.uhf_get_full_stat', {'err': 0, 'HFXT': 0, 'UartBaud':1, 'Reset': 0, 'RF Mode': 3, 'Echo': 0, 'BCN': 0, 'PIPE': 0, 'Bootloader': 0, 'CTS': 0, 'SEC': 1, 'FRAM': 0, 'RFTS': 0, 'Frequency': 436000000, 'PIPE timeout': 30, 'Beacon period': 89, 'Audio trans. period': 536, 'Uptime': 12, 'Packets out': 100, 'Packets in': 70, 'Packets in CRC16': 10, 'Temperature': np.float32(18.4), 'Low power status': 0, 'Payload Size': 127, 'Secure key': 32})
    ...
    sendAndExpect('obc.communication.uhf_get_callsign', {'err': 0, 'Destination': 'CQ12AB', 'Source': 'UX1UHF'})
    sendAndExpect('obc.communication.uhf_set_morse(--.--..-.---..-.-.-..-.--..-..--)', {'err':0})
    sendAndExpect('obc.communication.uhf_get_morse', {'err': 0, 'Morse': '--.--..-.---..-.-.-..-.--..-..--'})
    sendAndExpect('obc.communication.uhf_set_midi(H67H69H71H)', {'err':0}) #67H69H71H67H67H69H71H67H71H72H74W71H72H74W
    sendAndExpect('obc.communication.uhf_get_midi', {'err': 0, 'MIDI': 'H67H69H71H'})
    sendAndExpect('obc.communication.uhf_set_beacon_msg(HelloAlbertaSat)', {'err':0})
    sendAndExpect('obc.communication.uhf_get_beacon_msg', {'err': 0, 'Beacon Message': 'HELLOALBERTASAT'})
    ...
    sendAndExpect('obc.communication.uhf_set_params(437500000 45 60 70)', {'err':0})
    sendAndExpect('obc.communication.uhf_get_full_stat', {'err': 0, 'HFXT': 0, 'UartBaud':1, 'Reset': 0, 'RF Mode': 3, 'Echo': 1, 'BCN': 1, 'PIPE': 1, 'Bootloader': 0, 'CTS': 0, 'SEC': 1, 'FRAM': 0, 'RFTS': 0, 'Frequency': 437500000, 'PIPE timeout': 45, 'Beacon period': 60, 'Audio trans. period': 70, 'Uptime': 12, 'Packets out': 100, 'Packets in': 70, 'Packets in CRC16': 10, 'Temperature': np.float32(18.4), 'Low power status': 0, 'Payload Size': 127, 'Secure key': 32})
