...
def testAllCommandsToOBC():
    test.sendAndExpect(
        "obc.communication.UHF_SET_SCW(0 1 0 3 0 0 0 0 0 1 0 0)", {"err": 0}
    )  # sometimes it won't reach its subservice!
    ...
    test.sendAndExpect(
        "obc.communication.uhf_get_full_stat",
        {
            "err": 0,
            "HFXT": 0,
            "UartBaud": 1,
            ...
            "PIPE timeout": 30,
            "Beacon period": 89,
            "Audio trans. period": 536,
            "Uptime": 12,
            "Packets out": 100,
            "Packets in": 70,
            "Packets in CRC16": 10,
            "Temperature": np.float32(18.4),
        },
    )
